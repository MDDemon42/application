...
import { OneTDGCharacter } from './createOneTDGCharacher';

export interface TDGCharacterOnHire {
    character: OneTDGCharacter,
    startingAbility: TDGAbility | null
}

const createTDGCharacterOnHire = (
    ...
    let startingAbility = common.abilities.range.basic;
